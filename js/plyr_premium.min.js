"object" == typeof navigator && function(e, t) {
    ...
    var Ae = {
        ...
        getLabel: function(e, t) {
            ...
            case "quality":
                if (N.number(t)) {
                    var n = ge("qualityBadge.".concat(t), this.config);
                    return n.length ? n : "".concat(t, "")
                }
                return he(t);
            case "captions":
    ...
    var Pe = {
      ...
      , Ne = {
        ...
        quality: {
            default: 576,
            options: [4320, 2880, 2160, 1440, 1080, 720, 576, 480, 360, 240, 4, 3, 2, 1]
        },
        loop: {
            active: !1
        },
